...
function _initAddition(self, coll1, coll2) {
  assert(coll1.addAll, "must be a Collection");
  assert(coll2.addAll, "must be a Collection");
  self._coll1 = coll1;
  self._coll2 = coll2;
...
class SubtractCollection extends ArrayColl {
  constructor(collBase, collSubtract) {
    super();
    assert(collBase.addAll, "must be a Collection");
    assert(collSubtract.addAll, "must be a Collection");
...
class FilteredCollection extends ArrayColl {
  constructor(source, filterFunc) {
    ...
    assert(source.addAll, "must be a Collection");
    //this._source = source;
...
exports.AdditionCollection = AdditionCollection;
exports.AdditionCollectionWithDups = AdditionCollectionWithDups;
exports.SubtractCollection = SubtractCollection;
exports.IntersectionCollection = IntersectionCollection;
exports.MapToCollection = MapToCollection;
